...
int main(int argc, char* argv[]){
    ...
    std::string p1 = "/home/roborex/workspace/github/slam/ImageQualityEnhancement/registration/optical_flow/lkpyramid/LK1.png";
    std::string p2 = "/home/roborex/workspace/github/slam/ImageQualityEnhancement/registration/optical_flow/lkpyramid/LK2.png";
    Mat src1 = imread(p1, 0);
    Mat src2 = imread(p2, 0);
    
    // resize(src1, src1, src1.size()/4);
    // resize(src2, src2, src1.size());

    Mat gray_src1, gray_src2;
    gray_src1 = src1.clone();
    gray_src2 = src2.clone();
    cvtColor(gray_src1, src1, COLOR_GRAY2BGR);
    cvtColor(gray_src2, src2, COLOR_GRAY2BGR);
